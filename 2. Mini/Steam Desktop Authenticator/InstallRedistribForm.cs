...
namespace Steam_Desktop_Authenticator
{
    public partial class InstallRedistribForm : Form
    {
        ...
        private void InstallProcess_Exited(object sender, EventArgs e)
        {
            if (inlineInstall)
            {
                MessageBox.Show("Install complete! You may need to restart " + Manifest.MainAppName + " to view confirmations.", "Visual C++ Redistributable 2013", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
