...
namespace Steam_Desktop_Authenticator
{
    public partial class MainForm : Form
    {
        ...
        private void loadAccountsList()
        {
            ...
            menuDeactivateAuthenticator.Enabled = btnTradeConfirmationsList.Enabled = menuLoginAgain.Enabled = btn_forceSessionRefreshForAllAccounts_ToolStripMenuItem.Enabled = menuRemoveAccountFromManifest.Enabled = menuDeactivateAuthenticator.Enabled = allAccounts.Length > 0;
